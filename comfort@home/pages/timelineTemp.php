...
<?
    ...
    $value = getTimeline($link, $node_id, $querytime, 'temperature', $timeStart, $timeEnd);
    xmlWrite('sample.xml', 'dc7100', $node_id, $value, 'Celius', $section, $timeStart, $timeEnd);
?>
...
YUI().use("node-base", "io", function (Y) {
    ...
    Y.later(0, null, function () {
        Y.io("comet-temp.php?room="+document.queryForm.room.value);
    }, null, false);
...
<body>
    ...
    <div id="main">
         <div class="room-change">
             <form action="timelineTemp.php" method="post" name="queryForm">
        ...
        <div id="type-sidebar">
            ...
            <div id="type-image">
                <img src="../images/icon_temperature.png" width="40" />
            </div>
            <span id="type-info"><div id='showTemp'></div></span>  
            <ul id="type-detail">
        ...
        <div id="timeline">
            ...
            <form action="timelineTemp.php" method="post" name="previousForm">
            ...
            <form action="timelineTemp.php" method="post" name="forwardForm">
