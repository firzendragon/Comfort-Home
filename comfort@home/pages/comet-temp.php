...
$sql = "select value from data where node_id = '$node_id' and sensor_name = 'temperature' order by context_id desc limit 1";
$result = mysql_query($sql, $link) or die("EXECUTE SQL FAILED!!");
$row = mysql_fetch_assoc($result) or die("READ DATA FAILED");
echo "<font size=50 face='Impact'>".round($row["value"],1)."</font> <font style='font-size:22px;'>&degC</font>";
