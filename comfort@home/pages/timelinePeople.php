...
<?
    ...
    $value = getTimeline($link, $node_id, $querytime, 'motion', $timeStart, $timeEnd);
    xmlWrite('sample.xml', '7100DC', $node_id, $value, 'People', $section, $timeStart, $timeEnd);
?>
...
YUI().use("node-base", "io", function (Y) {
    ...
    Y.later(0, null, function () {
        Y.io("comet-people.php?room="+document.queryForm.room.value);
    }, null, false);
...
<body>
    ...
    <div id="main">
         <div class="room-change">
             <form action="timelinePeople.php" method="post" name="queryForm">
                ...
                <select name="node_id" onChange="queryForm.submit();">
                    <?
                        ...
                        while($row = mysql_fetch_assoc($result)){
                            if($row["node_id"] == $node_id)  echo "<option value=".$row["node_id"]." selected>".$row["node_id"];
                            else                             echo "<option value=".$row["node_id"].">".$row["node_id"];
                        }
                    ?>
                </select>
        ...
        <div id="type-sidebar">
            ...
            <div id="type-image">
                <img src="../images/icon_people.png" width="40" />
            </div>
            <span id="type-info"><div id='showPeople'></div></span>  
            <ul id="type-detail">
        ...
        <div id="timeline">
            ...
            <form action="timelinePeople.php" method="post" name="previousForm">
            ...
            <form action="timelinePeople.php" method="post" name="forwardForm">
