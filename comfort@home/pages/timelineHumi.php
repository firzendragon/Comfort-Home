...
<?
    ...
    $value = getTimeline($link, $node_id, $querytime, 'humidity', $timeStart, $timeEnd);
    xmlWrite('sample.xml', '007afa', $node_id, $value, 'Percentage', $section, $timeStart, $timeEnd);
?>
...
YUI().use("node-base", "io", function (Y) {
    ...
    Y.later(0, null, function () {
        Y.io("comet-humi.php?room="+document.queryForm.room.value);
    }, null, false);
...
<body>
    ...
    <div id="main">
         <div class="room-change">
            <form action="timelineHumi.php" method="post" name="queryForm">
        ...
        <div id="type-sidebar">
            ...
            <div id="type-image">
                <img src="../images/icon_humidity.png" width="40" />
            </div>
            <span id="type-info"><div id='showHumi'></div></span>  
            <ul id="type-detail">
        ...
        <div id="timeline">
            ...
            <form action="timelineHumi.php" method="post" name="previousForm">
            ...
            <form action="timelineHumi.php" method="post" name="forwardForm">
